...
namespace ApiUsuario.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IEnumerable<UsuarioModel> Get()
        {
            ...
            usuarioModels.Add(new UsuarioModel() { Id = 1, Name = "Kaue Urzedo", Email = "kaueurzedo13@hotmail.com"});
        ...
        {
           UsuarioModel usuario = new UsuarioModel() { Id = 1, Name = "Kaue Urzedo", Email = "kaueurzedo13@hotmail.com" };
